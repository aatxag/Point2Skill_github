...
Usage:
  python eval_franka_2cam_contact.py path/to/checkpoint.ckpt \\
      --hand_eye converters/my_data/hand_eye_result.yaml
"""
...
def main():
    ...
    _DEFAULT_Q_START = [
        -0.07029999792575836, -1.2699999809265137, 0.16349999606609344, -2.759500026702881, 0.20419999957084656, 1.79830002784729, -2.3066000938415527,
    ]
    ...
    parser.add_argument("--q_start", nargs=7, type=float,
                        default=_DEFAULT_Q_START, metavar="Q",
